...
1. Code:
The entire Program is written in the file "get_data.m". This folder contains other programs as well. In order to run it, the path to the "u.data" file will have to be changed in the "get_data.m" script.
